...
// Expert-portal sign-in: email + admin-provisioned personal code. On success
// the server sets the httpOnly cookie and we refresh so the server component
// re-renders in the authed state.
          ...
          <form onSubmit={submit} className="mt-5 flex flex-col gap-4">
            ...
            <label className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="rounded-lg border border-gray-300 px-3 py-2 text-sm font-mono tracking-wide text-brand-dark outline-none transition-colors focus:border-brand-red focus:ring-2 focus:ring-brand-red/20"
              />
            </label>
